<{include file="./layout/header.tpl"}>
    ...
    <div id="wrapper">
        ...
        <div class="content-holder">
            <!-- Page title -->
            <div class="dynamic-title">北京万宝力</div>
            <!-- Page title  end-->
            <!-- content  -->
            <div class="content full-height">
                ...
                <div class="hero-wrap">
                    ...
                    <div class="slideshow-item owl-carousel" data-top-bottom="transform: translateY(300px);" data-bottom-top="transform: translateY(-300px);">
                        <!-- 1 -->
                        <div class="item">
                            <div class="bg" style="background-image:url(<{$baseUrl}>/images/bg/1.jpg)"></div>
                        </div>
                        <!-- 2 -->
                        <div class="item">
                            <div class="bg" style="background-image:url(<{$baseUrl}>/images/bg/2.jpg)"></div>
                        </div>
                        <!-- 3 -->
                        <div class="item">
                            <div class="bg" style="background-image:url(<{$baseUrl}>/images/bg/3.jpg)"></div>
                        </div>
                    </div>
                    <!-- Hero image   end -->
                ...
                <section id="sec1">
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="parallax-box slider-box ">
                                    <div class="single-slider-holder">
                                        <div class="single-slider">
                                            <!-- 1 -->
                                            <div class="item">
                                                <img src="<{$baseUrl}>/<{$data['img_1']}>" alt="">
                                            </div>
                                            <!-- 1 end-->
                                            <!-- 2 -->
                                            <div class="item">
                            ...
                            <div class="col-md-8">
                                <!-- section title  -->
                                <h2 class="section-title art1">企业简介</h2>
                                <!-- section title  end -->
                                <p class="text big">北京万宝力防水防腐技术开发有限公司（以下简称：万宝力）是中国建筑防水协会资深理事会员、中国著名品牌、首都高新技术企业。在中国拥有2家生产基地，主营建筑防水业务。2015年销售各类防水卷材过千万平方米，防水涂料近20万吨，防水施工面积近500万平方米。公司旗下品牌“金奥“，投资涉及建筑节能和能源化工等多个领域。</p>
                                <p class="text big">北京万宝力防水防腐技术开发有限公司控股山东万宝力防水防腐技术开发有限公司、北京万宝力防水保温工程有限公司。公司在北京大兴、山东德州拥有两家生产基地，拥有世界领先的多功能进口改性沥青防水卷材生产线、冷自粘沥青防水卷材生产线、高分子卷材生产线和世界先进的环保防水涂料。</p>

                                <div class="process-box">
                                    <h3 class="art1" >我的定位 你的选择</h3>
                                ...
                                <div class="gallery-items  grid-small-pad lightgallery">
                                    ...
                                    <div class="gallery-item">
                                        <div class="grid-item-holder">
                                            <div class="box-item">
                                                <a data-src="<{$baseUrl}>/images/folio/tixi-hr.png" class="popup-image" data-sub-html="万宝力防水体系">
                                                    <span class="overlay"></span>
                                                    <img  src="<{$baseUrl}>/images/folio/tixi.png"   alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="content dark-bg">
                ...
                <div class="parallax-inner">
                    <div class="bg" data-bg="<{$baseUrl}>/images/bg/1.jpg" data-top-bottom="transform: translateY(300px);" data-bottom-top="transform: translateY(-300px);"></div>
                    <div class="overlay"></div>
                </div>
                <!-- parallax image  end -->
                <section>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                                <h2 class="section-title art1">企业荣誉</h2>
                            </div>
                            <div class="col-md-8">
            ...
            <div class="content">
                <section>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="section-title algn-right dec-title art1"><span>企业理念</span></h2>
                            </div>
                        </div>
                        <!--  section title end  -->
                        <!--  Parallax items  -->
                                ...
                                <div class="parallax-item left-direction">
                                    <div class="paralax-media">
                                        <div class="paralax-wrap">
                                            <img src="<{$baseUrl}>/images/folio/thumbs/3.jpg" class="respimg" alt="">
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="parallax-item right-direction">
                                    <div class="paralax-media">
                                        <ul class="creat-list">
                                            <li><a href="#">不断研发低碳、环保、节能新型防水产品，让客户感受到与众不用</a></li>
                                            <li><a ></a></li>
                                        </ul>
                                        <div class="paralax-wrap">
                                            <img src="<{$baseUrl}>/images/folio/thumbs/4.jpg" class="respimg" alt="">
                                        </div>
                                    </div>
                                    <div class="parallax-deck" data-top-bottom="transform: translateY(-200px);" data-bottom-top="transform: translateY(200px);">
                                        <div class="parallax-deck-item">
                                            <h3>万宝力在<strong>倾听</strong></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="parallax-item left-direction">
                                    <div class="paralax-media">
                                        <ul class="creat-list">
                                            <li><a href="#">全身心倾听，领会客户对防水的需求</a></li>
                                            <li><a ></a></li>
                                        </ul>
                                        <div class="paralax-wrap">
                                            <img src="<{$baseUrl}>/images/folio/thumbs/5.jpg" class="respimg" alt="">
                                        </div>
                                    </div>
                                    <div class="parallax-deck" data-top-bottom="transform: translateY(-200px);" data-bottom-top="transform: translateY(200px);">
                                        <div class="parallax-deck-item">
                                            <h3>万宝力在<strong>建议</strong></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="parallax-item right-direction">
                                    <div class="paralax-media">
                                        <ul class="creat-list">
                                            <li><a href="#">与客户共同探寻防水系统，给出正确的策略建议</a></li>
                                            <li><a ></a></li>
                                        </ul>
                                        <div class="paralax-wrap">
                                            <img src="<{$baseUrl}>/images/folio/thumbs/6.jpg" class="respimg" alt="">
                                        </div>
                                    </div>
                                    <div class="parallax-deck" data-top-bottom="transform: translateY(-200px);" data-bottom-top="transform: translateY(200px);">
                                        <div class="parallax-deck-item">
                                            <h3>万宝力在<strong>执行</strong></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
