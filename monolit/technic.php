                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <article>
                                            ...
                                            <div class="blog-media">
                                                <div class="box-item">
                                                    ...
                                                    <img src="image/folio/thumbs/17.jpg"  alt="" class="respimg">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="blog-text">
                                        ...
                                        <div class="pagination-blog">
                                            <a href="#" class="prevposts-link transition"></a>
                                            ...
                                            <a href="#" class="nextposts-link transition"></a>
                                        </div>
                                    </div>
                                    <!-- Articels end-->
                                    <!-- sidebar -->
                                        ...
                                        <div class="sidebar">
                                            ...
                                            <div class="widget">
                                                ...
                                                <ul class="widget-posts">
                                                    <li class="clearfix">
                                                        <a href=""  class="widget-posts-img"><img src="image/folio/thumbs/1.jpg" class="respimg" alt=""></a>
                                            ...
                                            <div class="widget">
                                                ...
                                                <ul>
                                                    <li class="cat-item"><a href="#">新闻动态</a> (3)</li>
                                                    <li class="cat-item"><a href="#">施工工艺</a> (6)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
